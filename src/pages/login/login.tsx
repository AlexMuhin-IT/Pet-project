...
export function Login() {
	...
	return (
		<div className="p-2">
			<h3>Введите зарегистрированные данные: </h3>
			<div>
				<div>
					<form className={s.container} onSubmit={handleSubmit(onSubmit)}>
						{/*<div>*/}
						{/*	<span>Данные для входа логин: your_email@example.com</span>*/}
						{/*	<br/>*/}
						{/*	<span>Данные для входа пароль: YourPasswo12!!</span>*/}
						{/*</div>*/}
						<input
						...
						<Button name={'Login'} className={s.buttonLogin}/>
					</form>
				</div>
			</div>
		</div>
